...
<html>
  ...
  <body>
    ...
    <div class="furdiv">
      ...
      <div class="osbuttons">
        <div class="osbutton">
          <a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-win64.zip"><img class="furbutton" src="/storage/images/win.png" alt="Windows"/></a>
          <p>Windows (64-bit)</p>
        </div>
        <div class="osbutton">
          <a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-mac-Intel.dmg"><img class="furbutton" src="/storage/images/mac.png" alt="macOS"/></a>
          <p>macOS (Intel)</p>
        </div>
        <div class="osbutton">
          <a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-mac-arm64.dmg"><img class="furbutton" src="/storage/images/mac.png" alt="macOS"/></a>
          <p>macOS (Apple silicon)</p>
        </div>
        <div class="osbutton">
          <a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-linux-x86_64.tar.gz"><img class="furbutton" src="/storage/images/linux.png" alt="Linux"/></a>
          <p>Linux (x86_64)</p>
        </div>
      </div>
      <p style="text-align: center; color: #aaa;">latest version: 0.6.2 (2024-02-03)<br/><a href="https://github.com/tildearrow/furnace/releases/tag/v0.6.2">click for release notes (GitHub)</a></p>
      <div class="furspace">
	<div class="fursub">
          ...
          <div class="furhide">
          <ul>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-win64.zip">Windows (64-bit)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-win32.zip">Windows (32-bit; Vista or later)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-win32-XP-ONLY.zip">Windows (32-bit; XP-only)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-mac-Intel.dmg">macOS (64-bit Intel)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-mac-arm64.dmg">macOS (Apple silicon)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-linux-x86_64.tar.gz">Linux (x86_64; tar)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/Furnace-0.6.2-x86_64.AppImage">Linux (x86_64; AppImage)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-linux-armhf.tar.gz">Linux (32-bit ARM)</a></li>
            <li><a href="https://github.com/tildearrow/furnace/releases/download/v0.6.2/furnace-0.6.2-linux-aarch64.tar.gz">Linux (AArch64)</a></li>
          </ul>
          </div>
        </div>
        <div class="fursub">
